...
#include "Article/Gameplay/Sync/SyncEventReceiveSystem.h"
#include "Article/Gameplay/Sync/SyncTransformReceiveSystem.h"
...
void TickThread::Begin(entt::registry& registry)
{
	...
	thread_data.Config = Li::Application::Get<ArticleApp>().GetConfig();
